...
<body class="align">
	...
	<div class="site__container">
		...
		<div class="grid__container">
			...
			<form action="/log/login.do" method="post" class="form form--login">
				<div><h1>HELLO!:D</h1></div>
				<div class="form__field">
					<label class="fontawesome-user" for="login__username"><span
						class="hidden">Username</span></label> <input id="login__username"
						type="text" class="form__input" placeholder="Username" name="m_id"
						required>
				</div>
			...
			<p class="text--center">
				Not a member? <a href="/log/join">Sign up now</a> <span
					class="fontawesome-arrow-right"></span>
			</p>
			<p class="text--center">
				Forgot your PW? <a href="/log/findPW">click_here</a> <span
					class="fontawesome-arrow-right"></span>
			</p>
		</div>
